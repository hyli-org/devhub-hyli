...
If you don't need to create a custom identity source for your app, use [the Hyli wallet](../tooling/wallet.md) which provides a unified identity layer for Hyli applications.

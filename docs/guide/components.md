...
The application asynchronously proves all transactions. This proof can be generated by a prover network like Boundless or Succinct, by the application itself, or even client-side: in the context of our Dex, the app generates the proofs.
